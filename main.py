...
def calcular_dias(vacacion, ingreso, today):
            ...
            # Si esta vacio o es fecha correcta y el periodo es del año actual
                ...
                if PERIOD_YEAR == THIS_YEAR:
                    ...
                    if es_nan(vacacion):
                        ...
                        estado = states[3]  # 'No aplica'
                        dias = calcular_dias(vacacion, ingreso, TODAY)
...
df = process_data(VACACIONES)
df = transform_data(df, TODAY, THIS_YEAR, VACATION_PERIODS, VACACIONES['states'])
print(df.schema)